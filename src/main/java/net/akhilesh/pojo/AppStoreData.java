...
public class AppStoreData {
  ...
  ArrayList<String> appletvScreenshotUrls = new ArrayList<String>();
  ...
  public float getPrimaryGenreId() {
    return primaryGenreId;
  }

  public void setPrimaryGenreId(float primaryGenreId) {
  ...
  public void setVppDeviceBasedLicensingEnabled(boolean isVppDeviceBasedLicensingEnabled) {
  ...
  public void setUserRatingCount(float userRatingCount) {
